...
from tremendous_python_sdk.pydantic.order_payment import OrderPayment
from tremendous_python_sdk.pydantic.order_reward import OrderReward
...
class Order(BaseModel):
    ...
    payment: typing.Optional[OrderPayment] = Field(None, alias='payment')

    # The ID for the invoice associated with this order
    invoice_id: typing.Optional[str] = Field(None, alias='invoice_id')

    reward: typing.Optional[OrderReward] = Field(None, alias='reward')
    class Config:
