...
from tremendous_python_sdk.pydantic.invoice_orders import InvoiceOrders
from tremendous_python_sdk.pydantic.invoice_rewards import InvoiceRewards
...
class Invoice(BaseModel):
    ...
    orders: typing.Optional[InvoiceOrders] = Field(None, alias='orders')

    rewards: typing.Optional[InvoiceRewards] = Field(None, alias='rewards')
    class Config:
