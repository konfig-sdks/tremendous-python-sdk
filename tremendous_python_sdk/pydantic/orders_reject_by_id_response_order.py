...
from tremendous_python_sdk.pydantic.orders_reject_by_id_response_order_payment import OrdersRejectByIdResponseOrderPayment
from tremendous_python_sdk.pydantic.orders_reject_by_id_response_order_reward import OrdersRejectByIdResponseOrderReward

class OrdersRejectByIdResponseOrder(BaseModel):
    ...
    payment: typing.Optional[OrdersRejectByIdResponseOrderPayment] = Field(None, alias='payment')

    # The ID for the invoice associated with this order
    invoice_id: typing.Optional[str] = Field(None, alias='invoice_id')

    reward: typing.Optional[OrdersRejectByIdResponseOrderReward] = Field(None, alias='reward')
    class Config:
