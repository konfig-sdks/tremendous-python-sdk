...
from tremendous_python_sdk.pydantic.orders_approve_order_by_id_response_order_payment import OrdersApproveOrderByIdResponseOrderPayment
from tremendous_python_sdk.pydantic.orders_approve_order_by_id_response_order_reward import OrdersApproveOrderByIdResponseOrderReward

class OrdersApproveOrderByIdResponseOrder(BaseModel):
    ...
    payment: typing.Optional[OrdersApproveOrderByIdResponseOrderPayment] = Field(None, alias='payment')

    # The ID for the invoice associated with this order
    invoice_id: typing.Optional[str] = Field(None, alias='invoice_id')

    reward: typing.Optional[OrdersApproveOrderByIdResponseOrderReward] = Field(None, alias='reward')
    class Config:
