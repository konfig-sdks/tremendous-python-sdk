...
from tremendous_python_sdk.pydantic.orders_create_order201_response_order_payment import OrdersCreateOrder201ResponseOrderPayment
from tremendous_python_sdk.pydantic.orders_create_order201_response_order_reward import OrdersCreateOrder201ResponseOrderReward

class OrdersCreateOrder201ResponseOrder(BaseModel):
    ...
    payment: typing.Optional[OrdersCreateOrder201ResponseOrderPayment] = Field(None, alias='payment')

    # The ID for the invoice associated with this order
    invoice_id: typing.Optional[str] = Field(None, alias='invoice_id')

    reward: typing.Optional[OrdersCreateOrder201ResponseOrderReward] = Field(None, alias='reward')
    class Config:
