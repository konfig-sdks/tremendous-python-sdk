...
from tremendous_python_sdk.pydantic.member_with_events_events import MemberWithEventsEvents
...
class MemberWithEvents(BaseModel):
    ...
    events: typing.Optional[MemberWithEventsEvents] = Field(None, alias='events')
    class Config:
