...
from tremendous_python_sdk.pydantic.orders_create_order_response_order_payment import OrdersCreateOrderResponseOrderPayment
from tremendous_python_sdk.pydantic.orders_create_order_response_order_rewards import OrdersCreateOrderResponseOrderRewards

class OrdersCreateOrderResponseOrder(BaseModel):
    ...
    payment: typing.Optional[OrdersCreateOrderResponseOrderPayment] = Field(None, alias='payment')

    # The ID for the invoice associated with this order
    invoice_id: typing.Optional[str] = Field(None, alias='invoice_id')

    rewards: typing.Optional[OrdersCreateOrderResponseOrderRewards] = Field(None, alias='rewards')
    class Config:
