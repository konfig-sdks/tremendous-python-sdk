...
from tremendous_python_sdk.pydantic.orders_get_list_response_orders_item_payment import OrdersGetListResponseOrdersItemPayment
from tremendous_python_sdk.pydantic.orders_get_list_response_orders_item_reward import OrdersGetListResponseOrdersItemReward

class OrdersGetListResponseOrdersItem(BaseModel):
    ...
    payment: typing.Optional[OrdersGetListResponseOrdersItemPayment] = Field(None, alias='payment')

    # The ID for the invoice associated with this order
    invoice_id: typing.Optional[str] = Field(None, alias='invoice_id')

    reward: typing.Optional[OrdersGetListResponseOrdersItemReward] = Field(None, alias='reward')
    class Config:
