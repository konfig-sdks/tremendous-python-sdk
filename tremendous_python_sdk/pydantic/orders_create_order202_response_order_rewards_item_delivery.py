...
class OrdersCreateOrder202ResponseOrderRewardsItemDelivery(BaseModel):
    ...
    method: Literal["EMAIL", "LINK", "PHONE"] = Field(alias='method')
    ...
    status: Literal["SCHEDULED", "FAILED", "SUCCEEDED", "PENDING"] = Field(alias='status')
