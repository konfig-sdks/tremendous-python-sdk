...
from tremendous_python_sdk.pydantic.funding_sources_get_all_response_funding_sources_item_meta import FundingSourcesGetAllResponseFundingSourcesItemMeta

class FundingSourcesGetAllResponseFundingSourcesItem(BaseModel):
    ...
    meta: FundingSourcesGetAllResponseFundingSourcesItemMeta = Field(alias='meta')
