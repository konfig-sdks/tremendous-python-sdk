...
from tremendous_python_sdk.pydantic.invoices_create_and_fund_account_balance_response_invoice_orders import InvoicesCreateAndFundAccountBalanceResponseInvoiceOrders
from tremendous_python_sdk.pydantic.invoices_create_and_fund_account_balance_response_invoice_rewards import InvoicesCreateAndFundAccountBalanceResponseInvoiceRewards

class InvoicesCreateAndFundAccountBalanceResponseInvoice(BaseModel):
    # The invoice number
    ...
    orders: typing.Optional[InvoicesCreateAndFundAccountBalanceResponseInvoiceOrders] = Field(None, alias='orders')

    rewards: typing.Optional[InvoicesCreateAndFundAccountBalanceResponseInvoiceRewards] = Field(None, alias='rewards')
    class Config:
