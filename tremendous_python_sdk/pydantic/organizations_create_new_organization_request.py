...
from tremendous_python_sdk.pydantic.organizations_create_new_organization_request_copy_settings import OrganizationsCreateNewOrganizationRequestCopySettings

class OrganizationsCreateNewOrganizationRequest(BaseModel):
    ...
    copy_settings: typing.Optional[OrganizationsCreateNewOrganizationRequestCopySettings] = Field(None, alias='copy_settings')
