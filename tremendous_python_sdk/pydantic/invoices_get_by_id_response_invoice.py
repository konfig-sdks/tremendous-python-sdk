...
from tremendous_python_sdk.pydantic.invoices_get_by_id_response_invoice_orders import InvoicesGetByIdResponseInvoiceOrders
from tremendous_python_sdk.pydantic.invoices_get_by_id_response_invoice_rewards import InvoicesGetByIdResponseInvoiceRewards

class InvoicesGetByIdResponseInvoice(BaseModel):
    # The invoice number
    ...
    orders: typing.Optional[InvoicesGetByIdResponseInvoiceOrders] = Field(None, alias='orders')

    rewards: typing.Optional[InvoicesGetByIdResponseInvoiceRewards] = Field(None, alias='rewards')
    class Config:
