...
from tremendous_python_sdk.pydantic.order_without_link_payment import OrderWithoutLinkPayment
from tremendous_python_sdk.pydantic.order_without_link_reward import OrderWithoutLinkReward
...
class OrderWithoutLink(BaseModel):
    ...
    payment: typing.Optional[OrderWithoutLinkPayment] = Field(None, alias='payment')

    # The ID for the invoice associated with this order
    invoice_id: typing.Optional[str] = Field(None, alias='invoice_id')

    reward: typing.Optional[OrderWithoutLinkReward] = Field(None, alias='reward')
    class Config:
