...
from tremendous_python_sdk.pydantic.orders_create_order202_response_order_payment import OrdersCreateOrder202ResponseOrderPayment
from tremendous_python_sdk.pydantic.orders_create_order202_response_order_rewards import OrdersCreateOrder202ResponseOrderRewards

class OrdersCreateOrder202ResponseOrder(BaseModel):
    ...
    payment: typing.Optional[OrdersCreateOrder202ResponseOrderPayment] = Field(None, alias='payment')

    # The ID for the invoice associated with this order
    invoice_id: typing.Optional[str] = Field(None, alias='invoice_id')

    rewards: typing.Optional[OrdersCreateOrder202ResponseOrderRewards] = Field(None, alias='rewards')
    class Config:
