...
from tremendous_python_sdk.pydantic.funding_sources_get_by_id_response_funding_source_meta import FundingSourcesGetByIdResponseFundingSourceMeta

class FundingSourcesGetByIdResponseFundingSource(BaseModel):
    ...
    meta: FundingSourcesGetByIdResponseFundingSourceMeta = Field(alias='meta')
