...
from tremendous_python_sdk.pydantic.invoices_get_all_response_invoices_item_orders import InvoicesGetAllResponseInvoicesItemOrders
from tremendous_python_sdk.pydantic.invoices_get_all_response_invoices_item_rewards import InvoicesGetAllResponseInvoicesItemRewards

class InvoicesGetAllResponseInvoicesItem(BaseModel):
    # The invoice number
    ...
    orders: typing.Optional[InvoicesGetAllResponseInvoicesItemOrders] = Field(None, alias='orders')

    rewards: typing.Optional[InvoicesGetAllResponseInvoicesItemRewards] = Field(None, alias='rewards')
    class Config:
