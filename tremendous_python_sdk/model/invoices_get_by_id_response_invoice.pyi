...
class InvoicesGetByIdResponseInvoice(
    schemas.DictSchema
):
    """
...
the respective funds to your account's balance.
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def orders() -> typing.Type['InvoicesGetByIdResponseInvoiceOrders']:
                return InvoicesGetByIdResponseInvoiceOrders
        
            @staticmethod
            def rewards() -> typing.Type['InvoicesGetByIdResponseInvoiceRewards']:
                return InvoicesGetByIdResponseInvoiceRewards
            __annotations__ = {
                "id": id,
                "amount": amount,
                "status": status,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["orders"]) -> 'InvoicesGetByIdResponseInvoiceOrders': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["rewards"]) -> 'InvoicesGetByIdResponseInvoiceRewards': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["orders"]) -> typing.Union['InvoicesGetByIdResponseInvoiceOrders', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["rewards"]) -> typing.Union['InvoicesGetByIdResponseInvoiceRewards', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        orders: typing.Union['InvoicesGetByIdResponseInvoiceOrders', schemas.Unset] = schemas.unset,
        rewards: typing.Union['InvoicesGetByIdResponseInvoiceRewards', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
