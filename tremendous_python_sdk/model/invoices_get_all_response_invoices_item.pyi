...
class InvoicesGetAllResponseInvoicesItem(
    schemas.DictSchema
):
    """
...
the respective funds to your account's balance.
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def orders() -> typing.Type['InvoicesGetAllResponseInvoicesItemOrders']:
                return InvoicesGetAllResponseInvoicesItemOrders
        
            @staticmethod
            def rewards() -> typing.Type['InvoicesGetAllResponseInvoicesItemRewards']:
                return InvoicesGetAllResponseInvoicesItemRewards
            __annotations__ = {
                "id": id,
                "amount": amount,
                "status": status,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["orders"]) -> 'InvoicesGetAllResponseInvoicesItemOrders': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["rewards"]) -> 'InvoicesGetAllResponseInvoicesItemRewards': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["orders"]) -> typing.Union['InvoicesGetAllResponseInvoicesItemOrders', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["rewards"]) -> typing.Union['InvoicesGetAllResponseInvoicesItemRewards', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        orders: typing.Union['InvoicesGetAllResponseInvoicesItemOrders', schemas.Unset] = schemas.unset,
        rewards: typing.Union['InvoicesGetAllResponseInvoicesItemRewards', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'InvoicesGetAllResponseInvoicesItem':
        return super().__new__(
            cls,
            *args,
            paid_at=paid_at,
