...
class OrdersRejectByIdResponseOrder(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def payment() -> typing.Type['OrdersRejectByIdResponseOrderPayment']:
                return OrdersRejectByIdResponseOrderPayment
            invoice_id = schemas.StrSchema
        
            @staticmethod
            def reward() -> typing.Type['OrdersRejectByIdResponseOrderReward']:
                return OrdersRejectByIdResponseOrderReward
            __annotations__ = {
                "id": id,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["payment"]) -> 'OrdersRejectByIdResponseOrderPayment': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["invoice_id"]) -> MetaOapg.properties.invoice_id: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["reward"]) -> 'OrdersRejectByIdResponseOrderReward': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["payment"]) -> typing.Union['OrdersRejectByIdResponseOrderPayment', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["reward"]) -> typing.Union['OrdersRejectByIdResponseOrderReward', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        payment: typing.Union['OrdersRejectByIdResponseOrderPayment', schemas.Unset] = schemas.unset,
        invoice_id: typing.Union[MetaOapg.properties.invoice_id, str, schemas.Unset] = schemas.unset,
        reward: typing.Union['OrdersRejectByIdResponseOrderReward', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'OrdersRejectByIdResponseOrder':
        return super().__new__(
            cls,
            *args,
            created_at=created_at,
