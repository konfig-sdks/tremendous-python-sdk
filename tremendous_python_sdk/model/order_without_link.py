...
class OrderWithoutLink(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def payment() -> typing.Type['OrderWithoutLinkPayment']:
                return OrderWithoutLinkPayment
            invoice_id = schemas.StrSchema
        
            @staticmethod
            def reward() -> typing.Type['OrderWithoutLinkReward']:
                return OrderWithoutLinkReward
            __annotations__ = {
                "id": id,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["payment"]) -> 'OrderWithoutLinkPayment': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["invoice_id"]) -> MetaOapg.properties.invoice_id: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["reward"]) -> 'OrderWithoutLinkReward': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["payment"]) -> typing.Union['OrderWithoutLinkPayment', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["reward"]) -> typing.Union['OrderWithoutLinkReward', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        payment: typing.Union['OrderWithoutLinkPayment', schemas.Unset] = schemas.unset,
        invoice_id: typing.Union[MetaOapg.properties.invoice_id, str, schemas.Unset] = schemas.unset,
        reward: typing.Union['OrderWithoutLinkReward', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
