...
class OrdersApproveOrderByIdResponseOrderPayment(
    schemas.DictSchema
):
    """
...
Note that this property will only appear for processed orders (`status` is `EXECUTED`).
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def refund() -> typing.Type['OrdersApproveOrderByIdResponseOrderPaymentRefund']:
                return OrdersApproveOrderByIdResponseOrderPaymentRefund
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["refund"]) -> 'OrdersApproveOrderByIdResponseOrderPaymentRefund': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["refund"]) -> typing.Union['OrdersApproveOrderByIdResponseOrderPaymentRefund', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        refund: typing.Union['OrdersApproveOrderByIdResponseOrderPaymentRefund', schemas.Unset] = schemas.unset,
        channel: typing.Union[MetaOapg.properties.channel, str, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'OrdersApproveOrderByIdResponseOrderPayment':
