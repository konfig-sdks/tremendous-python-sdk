...
class OrdersGetListResponseOrdersItemPayment(
    schemas.DictSchema
):
    """
...
Note that this property will only appear for processed orders (`status` is `EXECUTED`).
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def refund() -> typing.Type['OrdersGetListResponseOrdersItemPaymentRefund']:
                return OrdersGetListResponseOrdersItemPaymentRefund
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["refund"]) -> 'OrdersGetListResponseOrdersItemPaymentRefund': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["refund"]) -> typing.Union['OrdersGetListResponseOrdersItemPaymentRefund', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        refund: typing.Union['OrdersGetListResponseOrdersItemPaymentRefund', schemas.Unset] = schemas.unset,
        channel: typing.Union[MetaOapg.properties.channel, str, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'OrdersGetListResponseOrdersItemPayment':
