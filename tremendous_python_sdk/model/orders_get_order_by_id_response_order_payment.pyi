...
class OrdersGetOrderByIdResponseOrderPayment(
    schemas.DictSchema
):
    """
...
Note that this property will only appear for processed orders (`status` is `EXECUTED`).
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def refund() -> typing.Type['OrdersGetOrderByIdResponseOrderPaymentRefund']:
                return OrdersGetOrderByIdResponseOrderPaymentRefund
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["refund"]) -> 'OrdersGetOrderByIdResponseOrderPaymentRefund': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["refund"]) -> typing.Union['OrdersGetOrderByIdResponseOrderPaymentRefund', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        refund: typing.Union['OrdersGetOrderByIdResponseOrderPaymentRefund', schemas.Unset] = schemas.unset,
