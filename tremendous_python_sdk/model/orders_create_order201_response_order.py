...
class OrdersCreateOrder201ResponseOrder(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def payment() -> typing.Type['OrdersCreateOrder201ResponseOrderPayment']:
                return OrdersCreateOrder201ResponseOrderPayment
            invoice_id = schemas.StrSchema
        
            @staticmethod
            def reward() -> typing.Type['OrdersCreateOrder201ResponseOrderReward']:
                return OrdersCreateOrder201ResponseOrderReward
            __annotations__ = {
                "id": id,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["payment"]) -> 'OrdersCreateOrder201ResponseOrderPayment': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["invoice_id"]) -> MetaOapg.properties.invoice_id: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["reward"]) -> 'OrdersCreateOrder201ResponseOrderReward': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["payment"]) -> typing.Union['OrdersCreateOrder201ResponseOrderPayment', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["reward"]) -> typing.Union['OrdersCreateOrder201ResponseOrderReward', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        payment: typing.Union['OrdersCreateOrder201ResponseOrderPayment', schemas.Unset] = schemas.unset,
        invoice_id: typing.Union[MetaOapg.properties.invoice_id, str, schemas.Unset] = schemas.unset,
        reward: typing.Union['OrdersCreateOrder201ResponseOrderReward', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'OrdersCreateOrder201ResponseOrder':
        return super().__new__(
            cls,
            *args,
            created_at=created_at,
