...
from tremendous_python_sdk.type.orders_reject_by_id_response_order_payment import OrdersRejectByIdResponseOrderPayment
from tremendous_python_sdk.type.orders_reject_by_id_response_order_reward import OrdersRejectByIdResponseOrderReward

class RequiredOrdersRejectByIdResponseOrder(TypedDict):
...
class OptionalOrdersRejectByIdResponseOrder(TypedDict, total=False):
    ...
    payment: OrdersRejectByIdResponseOrderPayment

    # The ID for the invoice associated with this order
    invoice_id: str

    reward: OrdersRejectByIdResponseOrderReward

class OrdersRejectByIdResponseOrder(RequiredOrdersRejectByIdResponseOrder, OptionalOrdersRejectByIdResponseOrder):
    pass
