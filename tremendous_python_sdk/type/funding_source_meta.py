...
class RequiredFundingSourceMeta(TypedDict):
    pass

class OptionalFundingSourceMeta(TypedDict, total=False):
...
class FundingSourceMeta(RequiredFundingSourceMeta, OptionalFundingSourceMeta):
    pass
