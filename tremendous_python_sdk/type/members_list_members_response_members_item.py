...
class RequiredMembersListMembersResponseMembersItem(TypedDict):
    id: str
...
class OptionalMembersListMembersResponseMembersItem(TypedDict, total=False):
...
class MembersListMembersResponseMembersItem(RequiredMembersListMembersResponseMembersItem, OptionalMembersListMembersResponseMembersItem):
    pass
