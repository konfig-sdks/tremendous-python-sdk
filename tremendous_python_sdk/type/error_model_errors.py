...
class RequiredErrorModelErrors(TypedDict):
    pass

class OptionalErrorModelErrors(TypedDict, total=False):
    # Error message
    message: str
...
class ErrorModelErrors(RequiredErrorModelErrors, OptionalErrorModelErrors):
    pass
