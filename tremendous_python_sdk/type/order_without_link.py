...
from tremendous_python_sdk.type.order_without_link_payment import OrderWithoutLinkPayment
from tremendous_python_sdk.type.order_without_link_reward import OrderWithoutLinkReward

class RequiredOrderWithoutLink(TypedDict):
...
class OptionalOrderWithoutLink(TypedDict, total=False):
    ...
    payment: OrderWithoutLinkPayment
...
class OrderWithoutLink(RequiredOrderWithoutLink, OptionalOrderWithoutLink):
    pass
