...
class RequiredOrganizationsGetListResponseOrganizationsItem(TypedDict):
...
class OptionalOrganizationsGetListResponseOrganizationsItem(TypedDict, total=False):
    id: str
...
class OrganizationsGetListResponseOrganizationsItem(RequiredOrganizationsGetListResponseOrganizationsItem, OptionalOrganizationsGetListResponseOrganizationsItem):
    pass
