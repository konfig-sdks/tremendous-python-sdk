...
class RequiredOrdersRejectByIdResponseOrderRewardDelivery(TypedDict):
...
class OptionalOrdersRejectByIdResponseOrderRewardDelivery(TypedDict, total=False):
    pass

class OrdersRejectByIdResponseOrderRewardDelivery(RequiredOrdersRejectByIdResponseOrderRewardDelivery, OptionalOrdersRejectByIdResponseOrderRewardDelivery):
    pass
