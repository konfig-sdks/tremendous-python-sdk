...
class RequiredOrdersGetOrderByIdResponseOrderRewardDelivery(TypedDict):
...
class OptionalOrdersGetOrderByIdResponseOrderRewardDelivery(TypedDict, total=False):
    pass

class OrdersGetOrderByIdResponseOrderRewardDelivery(RequiredOrdersGetOrderByIdResponseOrderRewardDelivery, OptionalOrdersGetOrderByIdResponseOrderRewardDelivery):
    pass
