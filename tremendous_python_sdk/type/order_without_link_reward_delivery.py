...
class RequiredOrderWithoutLinkRewardDelivery(TypedDict):
...
class OptionalOrderWithoutLinkRewardDelivery(TypedDict, total=False):
    pass

class OrderWithoutLinkRewardDelivery(RequiredOrderWithoutLinkRewardDelivery, OptionalOrderWithoutLinkRewardDelivery):
    pass
