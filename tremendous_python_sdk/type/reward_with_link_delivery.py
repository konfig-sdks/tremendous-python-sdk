...
class RequiredRewardWithLinkDelivery(TypedDict):
...
class OptionalRewardWithLinkDelivery(TypedDict, total=False):
...
class RewardWithLinkDelivery(RequiredRewardWithLinkDelivery, OptionalRewardWithLinkDelivery):
    pass
