...
class RequiredOrdersCreateOrderRequestRewardDelivery(TypedDict):
    pass

class OptionalOrdersCreateOrderRequestRewardDelivery(TypedDict, total=False):
...
class OrdersCreateOrderRequestRewardDelivery(RequiredOrdersCreateOrderRequestRewardDelivery, OptionalOrdersCreateOrderRequestRewardDelivery):
    pass
