...
from tremendous_python_sdk.type.orders_approve_order_by_id_response_order_payment import OrdersApproveOrderByIdResponseOrderPayment
from tremendous_python_sdk.type.orders_approve_order_by_id_response_order_reward import OrdersApproveOrderByIdResponseOrderReward

class RequiredOrdersApproveOrderByIdResponseOrder(TypedDict):
...
class OptionalOrdersApproveOrderByIdResponseOrder(TypedDict, total=False):
...
class OrdersApproveOrderByIdResponseOrder(RequiredOrdersApproveOrderByIdResponseOrder, OptionalOrdersApproveOrderByIdResponseOrder):
    pass
