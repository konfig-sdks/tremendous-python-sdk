...
class RequiredOrderWithLinkRewardsItemDelivery(TypedDict):
...
class OptionalOrderWithLinkRewardsItemDelivery(TypedDict, total=False):
...
class OrderWithLinkRewardsItemDelivery(RequiredOrderWithLinkRewardsItemDelivery, OptionalOrderWithLinkRewardsItemDelivery):
    pass
