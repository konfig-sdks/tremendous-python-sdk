...
from tremendous_python_sdk.type.orders_create_order202_response_order_payment import OrdersCreateOrder202ResponseOrderPayment
from tremendous_python_sdk.type.orders_create_order202_response_order_rewards import OrdersCreateOrder202ResponseOrderRewards

class RequiredOrdersCreateOrder202ResponseOrder(TypedDict):
...
class OptionalOrdersCreateOrder202ResponseOrder(TypedDict, total=False):
    ...
    payment: OrdersCreateOrder202ResponseOrderPayment

    # The ID for the invoice associated with this order
    invoice_id: str

    rewards: OrdersCreateOrder202ResponseOrderRewards

class OrdersCreateOrder202ResponseOrder(RequiredOrdersCreateOrder202ResponseOrder, OptionalOrdersCreateOrder202ResponseOrder):
    pass
