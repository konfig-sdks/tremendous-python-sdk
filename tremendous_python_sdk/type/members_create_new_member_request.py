...
class RequiredMembersCreateNewMemberRequest(TypedDict):
...
class OptionalMembersCreateNewMemberRequest(TypedDict, total=False):
    pass

class MembersCreateNewMemberRequest(RequiredMembersCreateNewMemberRequest, OptionalMembersCreateNewMemberRequest):
    pass
