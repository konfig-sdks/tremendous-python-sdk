...
class RequiredOrdersCreateOrderResponseOrderRewardsItemDelivery(TypedDict):
...
class OptionalOrdersCreateOrderResponseOrderRewardsItemDelivery(TypedDict, total=False):
...
class OrdersCreateOrderResponseOrderRewardsItemDelivery(RequiredOrdersCreateOrderResponseOrderRewardsItemDelivery, OptionalOrdersCreateOrderResponseOrderRewardsItemDelivery):
    pass
