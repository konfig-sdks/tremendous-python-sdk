...
from tremendous_python_sdk.type.orders_create_order201_response_order_payment import OrdersCreateOrder201ResponseOrderPayment
from tremendous_python_sdk.type.orders_create_order201_response_order_reward import OrdersCreateOrder201ResponseOrderReward

class RequiredOrdersCreateOrder201ResponseOrder(TypedDict):
...
class OptionalOrdersCreateOrder201ResponseOrder(TypedDict, total=False):
    ...
    payment: OrdersCreateOrder201ResponseOrderPayment

    # The ID for the invoice associated with this order
    invoice_id: str

    reward: OrdersCreateOrder201ResponseOrderReward

class OrdersCreateOrder201ResponseOrder(RequiredOrdersCreateOrder201ResponseOrder, OptionalOrdersCreateOrder201ResponseOrder):
    pass
