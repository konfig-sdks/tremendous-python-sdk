...
class RequiredDeliveryDetailsWithLink(TypedDict):
...
class OptionalDeliveryDetailsWithLink(TypedDict, total=False):
...
class DeliveryDetailsWithLink(RequiredDeliveryDetailsWithLink, OptionalDeliveryDetailsWithLink):
    pass
