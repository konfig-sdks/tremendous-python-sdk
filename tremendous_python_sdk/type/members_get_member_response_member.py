...
from tremendous_python_sdk.type.members_get_member_response_member_events import MembersGetMemberResponseMemberEvents

class RequiredMembersGetMemberResponseMember(TypedDict):
    id: str
...
class OptionalMembersGetMemberResponseMember(TypedDict, total=False):
    events: MembersGetMemberResponseMemberEvents

class MembersGetMemberResponseMember(RequiredMembersGetMemberResponseMember, OptionalMembersGetMemberResponseMember):
    pass
