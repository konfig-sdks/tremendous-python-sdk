...
from tremendous_python_sdk.type.member_with_events_events import MemberWithEventsEvents

class RequiredMemberWithEvents(TypedDict):
    id: str
...
class OptionalMemberWithEvents(TypedDict, total=False):
    events: MemberWithEventsEvents

class MemberWithEvents(RequiredMemberWithEvents, OptionalMemberWithEvents):
    pass
