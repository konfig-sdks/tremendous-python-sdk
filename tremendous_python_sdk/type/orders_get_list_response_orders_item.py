...
from tremendous_python_sdk.type.orders_get_list_response_orders_item_payment import OrdersGetListResponseOrdersItemPayment
from tremendous_python_sdk.type.orders_get_list_response_orders_item_reward import OrdersGetListResponseOrdersItemReward

class RequiredOrdersGetListResponseOrdersItem(TypedDict):
...
class OptionalOrdersGetListResponseOrdersItem(TypedDict, total=False):
    ...
    payment: OrdersGetListResponseOrdersItemPayment

    # The ID for the invoice associated with this order
    invoice_id: str

    reward: OrdersGetListResponseOrdersItemReward

class OrdersGetListResponseOrdersItem(RequiredOrdersGetListResponseOrdersItem, OptionalOrdersGetListResponseOrdersItem):
    pass
