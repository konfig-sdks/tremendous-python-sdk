...
class RequiredOrdersCreateOrder202ResponseOrderRewardsItemDelivery(TypedDict):
...
class OptionalOrdersCreateOrder202ResponseOrderRewardsItemDelivery(TypedDict, total=False):
...
class OrdersCreateOrder202ResponseOrderRewardsItemDelivery(RequiredOrdersCreateOrder202ResponseOrderRewardsItemDelivery, OptionalOrdersCreateOrder202ResponseOrderRewardsItemDelivery):
    pass
