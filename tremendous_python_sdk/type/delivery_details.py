...
class RequiredDeliveryDetails(TypedDict):
...
class OptionalDeliveryDetails(TypedDict, total=False):
    pass

class DeliveryDetails(RequiredDeliveryDetails, OptionalDeliveryDetails):
    pass
