...
class RequiredRewardForOrderCreateDelivery(TypedDict):
    pass

class OptionalRewardForOrderCreateDelivery(TypedDict, total=False):
...
class RewardForOrderCreateDelivery(RequiredRewardForOrderCreateDelivery, OptionalRewardForOrderCreateDelivery):
    pass
