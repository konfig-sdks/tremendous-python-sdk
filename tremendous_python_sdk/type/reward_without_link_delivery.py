...
class RequiredRewardWithoutLinkDelivery(TypedDict):
...
class OptionalRewardWithoutLinkDelivery(TypedDict, total=False):
    pass

class RewardWithoutLinkDelivery(RequiredRewardWithoutLinkDelivery, OptionalRewardWithoutLinkDelivery):
    pass
