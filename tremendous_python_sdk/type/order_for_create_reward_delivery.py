...
class RequiredOrderForCreateRewardDelivery(TypedDict):
    pass

class OptionalOrderForCreateRewardDelivery(TypedDict, total=False):
...
class OrderForCreateRewardDelivery(RequiredOrderForCreateRewardDelivery, OptionalOrderForCreateRewardDelivery):
    pass
