...
from tremendous_python_sdk.type.funding_source_meta import FundingSourceMeta

class RequiredFundingSource(TypedDict):
    id: str
...
class OptionalFundingSource(TypedDict, total=False):
    # **Only available when `method` is set to `invoice`.** 
    type: str

class FundingSource(RequiredFundingSource, OptionalFundingSource):
    pass
