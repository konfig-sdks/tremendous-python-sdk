...
class RequiredOrderRewardDelivery(TypedDict):
...
class OptionalOrderRewardDelivery(TypedDict, total=False):
    pass

class OrderRewardDelivery(RequiredOrderRewardDelivery, OptionalOrderRewardDelivery):
    pass
