...
class RequiredRewardDelivery(TypedDict):
...
class OptionalRewardDelivery(TypedDict, total=False):
    pass

class RewardDelivery(RequiredRewardDelivery, OptionalRewardDelivery):
    pass
