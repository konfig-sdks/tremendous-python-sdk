...
from tremendous_python_sdk.type.order_with_link_payment import OrderWithLinkPayment
from tremendous_python_sdk.type.order_with_link_rewards import OrderWithLinkRewards

class RequiredOrderWithLink(TypedDict):
...
class OptionalOrderWithLink(TypedDict, total=False):
    ...
    rewards: OrderWithLinkRewards

class OrderWithLink(RequiredOrderWithLink, OptionalOrderWithLink):
    pass
