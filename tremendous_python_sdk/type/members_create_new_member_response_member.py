...
class RequiredMembersCreateNewMemberResponseMember(TypedDict):
    id: str
...
class OptionalMembersCreateNewMemberResponseMember(TypedDict, total=False):
...
class MembersCreateNewMemberResponseMember(RequiredMembersCreateNewMemberResponseMember, OptionalMembersCreateNewMemberResponseMember):
    pass
