...
from tremendous_python_sdk.type.order_base_payment import OrderBasePayment

class RequiredOrderBase(TypedDict):
...
class OptionalOrderBase(TypedDict, total=False):
...
class OrderBase(RequiredOrderBase, OptionalOrderBase):
    pass
